...
namespace UltimateTeam.Toolkit.Constants
{
    internal class Resources
    {
        ...
        public const string AccountInfoXbox = "https://utas.s3.fut.ea.com/ut/game/fifa17/user/accountinfo?sku=FUT16AND&_={0}";
        ...
        public Resources(AppVersion appVersion)
        {
            switch (appVersion)
            {
                case AppVersion.WebApp:
                    ...
                    Validate = "https://www.easports.com/iframe/fut17/p/ut/game/fifa16/phishing/validate";
                    ...
                    AccountInfo = "https://www.easports.com/iframe/fut16/p/ut/game/fifa17/user/accountinfo?sku=FUT17WEB&_={0}";

                    Item = "https://fifa17.content.easports.com/fifa/fltOnlineAssets/B488919F-23B5-497F-9FC0-CACFB38863D0/2016/fut/items/web/{0}.json";
